...
fList = [
	#(user.home+"/Repository/data/dne/Asia.dne", 100),
	#(user.home+"/Repository/data/dne/Asia.dne", 1000),
	#(user.home+"/Repository/data/dne/Asia.dne", 4000),
	#(user.home+"/Repository/data/dne/Asia.dne", 16000),

	#(user.home+"/Repository/Papers/CKL/scripts/Metastatic/Metastatic.dne", 10),
	#(user.home+"/Repository/Papers/CKL/scripts/Metastatic/Metastatic.dne", 100),
	#(user.home+"/Repository/Papers/CKL/scripts/Metastatic/Metastatic.dne", 1000),
	#(user.home+"/Repository/Papers/CKL/scripts/Metastatic/Metastatic.dne", 4000),
	#(user.home+"/Repository/Papers/CKL/scripts/Metastatic/Metastatic.dne", 16000),

	#(user.home+"/Repository/data/dne/insurance.bif.dne",   100),
	#(user.home+"/Repository/data/dne/insurance.bif.dne",   250),
	#(user.home+"/Repository/data/dne/insurance.bif.dne",   500),
	#(user.home+"/Repository/data/dne/insurance.bif.dne",  1000),
	#(user.home+"/Repository/data/dne/insurance.bif.dne",  2000),
	#(user.home+"/Repository/data/dne/insurance.bif.dne",  4000),
	#(user.home+"/Repository/data/dne/insurance.bif.dne",  8000),
  	#(user.home+"/Repository/data/dne/insurance.bif.dne", 16000),
	(user.home+"/Repository/data/dne/insurance.bif.dne", 1000000),

	#(user.home+"/Repository/data/dne/Alarm.dne",   100),
	#(user.home+"/Repository/data/dne/Alarm.dne",   250),
	#(user.home+"/Repository/data/dne/Alarm.dne",   500),
 	#(user.home+"/Repository/data/dne/Alarm.dne",  1000),
 	#(user.home+"/Repository/data/dne/Alarm.dne",  2000),
	#(user.home+"/Repository/data/dne/Alarm.dne",  4000),
 	#(user.home+"/Repository/data/dne/Alarm.dne",  8000),
 	#(user.home+"/Repository/data/dne/Alarm.dne", 16000),

 	#(user.home+"/Repository/data/dne/hailfinder.bif.dne",   100),
 	#(user.home+"/Repository/data/dne/hailfinder.bif.dne",   250),
 	#(user.home+"/Repository/data/dne/hailfinder.bif.dne",   500),
 	#(user.home+"/Repository/data/dne/hailfinder.bif.dne",  1000),
 	#(user.home+"/Repository/data/dne/hailfinder.bif.dne",  2000),
 	#(user.home+"/Repository/data/dne/hailfinder.bif.dne",  4000),
 	#(user.home+"/Repository/data/dne/hailfinder.bif.dne",  8000),
 	#(user.home+"/Repository/data/dne/hailfinder.bif.dne", 16000),
